...
/** @defgroup GARAugmentedFaceRegionType */

/**
 * @ingroup GARAugmentedFaceRegionType
 * Defines face regions to query the transforms for. Left and right are defined relative to the
 * person that the mesh belongs to. To retrieve the center transform use `GARAugmentedFace#centerTransform`.
 */
